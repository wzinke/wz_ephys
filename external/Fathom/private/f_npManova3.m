...
result(7).so = {'factor 1x2x3'};
result(8).so = {'residual'};
result(9).so = {'total'};
...
for k = 1:iter
   ...
   % 1x2x3:
   [ignore,SS(7)] = f_npManova1(n,m(7),H{7},I,Gvar,0);
   SS(7).among = SS(7).among - SS(1).among - SS(2).among - SS(3).among - SS(4).among - SS(5).among - SS(6).among; % SS interaction
   df(7).among = df(1).among * df(2).among * df(3).among; % df interaction
   MS(7).among = SS(7).among/df(7).among;                 % MS interaction
   
	%-----Global residual df, SS, % MS:-----
   residual_df =  (n-1) - sum([df(1).among df(2).among df(3).among df(4).among df(5).among df(6).among  df(7).among]); 
   residual_SS = SS(1).total - sum([SS(1).among SS(2).among SS(3).among SS(4).among SS(5).among SS(6).among SS(7).among]);
   ...
   case 31 % all factors fixed:
	  ...
	  Fstat7(k) = MS(7).among/residual_MS;
	     	  
  case 32 % factors 1 & 2 fixed, 3 random:
	  Fstat1(k) = MS(1).among/MS(5).among;
	  Fstat2(k) = MS(2).among/MS(6).among;
	  Fstat3(k) = MS(3).among/(MS(5).among + MS(6).among - MS(7).among);
	  Fstat4(k) = MS(4).among/MS(7).among;
	  Fstat5(k) = MS(5).among/MS(7).among;
	  Fstat6(k) = MS(6).among/MS(7).among;
	  Fstat7(k) = MS(7).among/residual_MS;
 
	  
  case 33 % factor 1 fixed or random, 2 & 3 random:
	  Fstat1(k) = MS(1).among/(MS(4).among + MS(5).among - MS(7).among);
	  Fstat2(k) = MS(2).among/(MS(4).among + MS(6).among - MS(7).among);
	  Fstat3(k) = MS(3).among/(MS(5).among + MS(6).among - MS(7).among);
	  Fstat4(k) = MS(4).among/MS(7).among;
	  Fstat5(k) = MS(5).among/MS(7).among;
	  Fstat6(k) = MS(6).among/MS(7).among;
   ...
   if (k==1)
	  ...
	  result(7).df = df(7).among;
	  result(8).df = residual_df;
	  result(9).df = (n-1);
	  ...
	  result(7).SS = SS(7).among;
	  result(8).SS = residual_SS;
	  result(9).SS = SS(1).total;
	  ...
	  result(7).MS = MS(7).among;
	  result(8).MS = residual_MS;
	  result(9).MS = NaN;
...
if (iter==1)
   ...
   j7 = find(Fstat7(2:end) >= result(7).F);
