function  [x,y,utmzone] = f_deg2utm(Lat,Lon)
% - convert lat/lon vectors into UTM coordinates (WGS84)
% 
% USAGE: [E,N,utmzone] = f_deg2utm(Lat,Lon);
% 
% Inputs:
...
n2=length(Lon);
if (n1~=n2)
   fprintf('deg2utm: Error. Lat and Lon vectors should have the same length\n');
   return;
end
