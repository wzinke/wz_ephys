function f_RFclassPlot(model,E,I,M)
% - create diagnostic plots of a Random Forest classification
%
% USAGE: f_RFclassPlot(model,E,I,M);
%
...
% Feb-2010: renamed from 'f_RFplot' to indicate this is specifically for
%           classification
...
if (I>0) && (importance>0)
   ...
   bar(gIndex,0.5);
   xlabel('\bfVariable');
   yTxt = sprintf('Decrease in Node Impurity\n(Gini Index)');
   ylabel(yTxt,'FontWeight','bold');
